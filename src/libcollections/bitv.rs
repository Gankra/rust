...
impl Bitv {
    #[inline]
    fn process(&mut self, other: &Bitv, op: |uint, u32| -> u32) -> bool {
    ...
    pub fn all(&self) -> bool {
        ...
        (last_word == ((1 << self.nbits % u32::BITS) - 1) || last_word == !0u)
    }
...
impl BitvSet {
    ...
    /// Iterator over each u32 stored in `self` intersect `other`.
    ...
    /// Iterator over each u32 stored in the `self` setminus `other`.
